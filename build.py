...
.bnr{position:relative;border-radius:14px;overflow:hidden;aspect-ratio:20/6;border:1px solid var(--line);box-shadow:var(--sh);background:#0f2544}
.bnr .slide{position:absolute;inset:0;background:center/cover no-repeat;opacity:0;transition:opacity .8s;display:flex;align-items:center;padding:0 clamp(28px,6vw,68px)}
.bnr .slide.on{opacity:1}
.bnr .slide::before{content:"";position:absolute;inset:0;background:linear-gradient(90deg,rgba(11,37,74,.85),rgba(11,37,74,.35) 60%,transparent)}
...
<section class="banner"><div class="wrap">
  <div class="bnr" id="bnr">
    ...
    <div class="slide" style="background-image:url(assets/ev-day.jpg)"><div class="bcap"><span class="bk">MDRT Day</span><b>2026 한국 MDRT Day</b><span class="d">협회 대표 연례 행사 · 등록 안내</span></div></div>
    <div class="slide" style="background-image:url(assets/ev-conf.jpg)"><div class="bcap"><span class="bk">Membership</span><b>2026 회원 가입 안내</b><span class="d">최고의 전문가 네트워크에 합류하세요</span></div></div>
